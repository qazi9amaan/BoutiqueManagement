...
<div class="wrapper">
    ...
    <div id="main_content" class="container-fluid pr-0">
        <div class="header sticky-top d-flex align-items-baseline justify-content-between ">
            ...
            <a href="/new_order.php" title="Assign artisen to an order" class="btn-primary  btn-sm"><i class="fa fa-plus"></i>&nbsp;New Order</a>
        </div>  
                ...
                <div class="row ">
                    <div class="card-body">
                        ...
                        <div class=" d-flex pt-3  card-footer bg-primary text-white rounded border justify-content-between align-items-baseline ">
                            <h4 class="text-uppercase  lead">Completed Orders</h4>
                        </div>
                        <!-- SEARCHING -->
                        ...
                        <table class="table bg-white table-bordered  table-sm  ">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td >
                                       <button  data-order_id="<?php echo $row['order_id']; ?>" data-toggle="modal"  data-target="#make-changes" class="btn btn-success btn-sm mx-2 ml-md-0 mt-md-0  mt-1"><i class="fa fa-refresh"></i>&nbsp;Make changes</button>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
...
<div class="modal fade" id="make-changes" role="dialog">
    <div class="modal-dialog">
        <form action="/orders/make_changes_to_complete_order.php?r=/users/admin/admin-items/Orders/Completed-Orders.php" method="POST">
            <!-- Modal content -->
            <div class="modal-content">
                ...
                <div class="modal-body mb-0 pb-0">
                    ...
                    <p class="text-center"> Are you sure you want to make change to the order?<br>
                    <i class="fa fa-arrow-circle-o-right"></i>
                    Assigning artisen to <strong> OR- <span id="art-order-id"></span></strong>
                    ...
                    <div class="form-group">
                    <label for="">New Delivery date</label>
                    <input type="date" name="delivery_date" class=" form-control">
                    </div>
                    <div class="form-group">
                    <label for="">Reason</label>
                    <textarea name="extended_reason" class=" form-control" rows="2"></textarea>
                    </div>
                    </p>
                </div>
...
<script>
$('#make-changes').on('show.bs.modal', function (event) {
